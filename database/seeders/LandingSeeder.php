...
class LandingSeeder extends Seeder
{
    public function run(): void
    {
        ...
        HeroSection::query()->create([
            ...
            'headline' => 'Ремонт санузла под ключ в Минске — ванная, туалет, плитка и цена в смете',
        ...
        AboutSection::query()->create([
            'title' => 'Ремонт ванной и санузла под ключ — без сюрпризов по цене',
            ...
            'body' => '<p>Наши услуги на лендинге совпадают с тем, что делаем на объекте:</p><ul class="mt-3 list-disc space-y-2 pl-5"><li>ремонт санузла и ванной под ключ, в том числе санузел под ключ и ремонт с материалом;</li><li>укладка плитки, плиточные работы под ключ, отделка санузла;</li><li>гидроизоляция ванной и санузла, демонтаж плитки в ванной;</li><li>сантехника и инсталляция в санузле;</li><li>выезд плиточника на дом на замер и смету.</li></ul><p class="mt-4">Для небольших и совмещённых санузлов подбираем раскладку и график; керамогранит и мозаику ведёт та же бригада, что и черновые работы.</p>',
            'stats' => [
        ...
        $services = require __DIR__.'/data/renovation_services.php';
        ...
        Review::query()->create([
            'author' => 'Марина К.',
            'body' => 'Ремонт санузла под ключ в новостройке — цена в смете не менялась, ванная и туалет сданы в срок. Плиточник аккуратный, швы ровные.',
            'rating' => 5,
        ...
        Review::query()->create([
            'author' => 'Андрей Л.',
            'body' => 'Заказывали ремонт ванной под ключ с материалом: керамогранит, гидроизоляция, душевой угол с уклоном. Стоимость ремонта санузла обсудили до старта.',
            'rating' => 5,
        ...
        Review::query()->create([
            'author' => 'Ольга В.',
            'body' => 'Маленький совмещённый санузел — монтаж инсталляции и укладка плитки. Частный плиточник приезжал на замер, всё объяснили по этапам.',
            'rating' => 5,
